...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('cms_slider_text_create')}}" class="btn btn-primary">Add </a>
        </div>
        <div class="card-body">
                ...
                <table id="client_table"  class="table table-striped">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('cms_slider_text_edit', $slider->id) }}" class="btn btn-outline-success me-2">Edit</a>
                                    <form action="{{ route('cms_slider_text_delete', $slider->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
