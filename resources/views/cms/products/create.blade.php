...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            <form action="{{route('cms_product_store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="pb-4">
                        ...
                        <textarea class="form-control" id="desc1" name="desc1" ></textarea>
                    </div>
                    ...
                    <div class="pb-4 col-md-6">
                        ...
                        <input type="text" class="form-control" id="category4" name="category4" />
                    </div>
                    ...
                    <div class="pb-4">
                        ...
                        <textarea class="form-control" id="desc2" name="desc2" ></textarea>
                    </div>
                    <div class="pb-4">
                        <label for="small_title_components" class="form-label">Small title components</label>
                        <input type="text" class="form-control" id="small_title_components" name="small_title_components" />
                    </div>
