...
@section('page_name') Catalogs Page @endsection
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            <form action="{{route('header_catalog_store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="pb-4">
                        @if($page->image_header)
                          <img src="{{asset('assets/catalog/'.$page->image_header)}}" height="100">
                        @endif
                    </div>
                    <div class="pb-4">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('cms_catalog_create')}}" class="btn btn-primary">Add Catalog</a>
        </div>
        <div class="card-body">
                ...
                <table id="client_table"  class="table table-striped">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr  class="gradeX">
                            ...
                            <td>  @if ($catalog->pdf)
                                  <a href="{{asset('assets/catalog/'.$catalog->pdf)}}">View Pdf</a>
                                  @endif
                            </td>
                            <td>
                                @if ($catalog->image)
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('cms_catalog_edit', $catalog->id) }}" class="btn btn-outline-success me-2">Edit</a>
                                    <form action="{{ route('cms_catalog_delete', $catalog->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
