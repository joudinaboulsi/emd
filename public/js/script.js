...
(function ($) {
	...
	// gallery image popup start here ***
	...
	// gallery image popup end here ***

	// flyer image popup start here ***
	$(document).ready(function() {
		$(".flyer-popup").magnificPopup({
			type: "image",
			closeBtnInside: true,
		});
	});
	// flyer image popup end here ***
